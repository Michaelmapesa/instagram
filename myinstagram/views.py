...
from .forms import NewImageForm, UpdatebioForm, ReviewForm, NewUserForm
...
def register_request(request):
	...
	form = NewUserForm()
	return render (request=request, template_name="registeration_form.html", context={"register_form":form})
